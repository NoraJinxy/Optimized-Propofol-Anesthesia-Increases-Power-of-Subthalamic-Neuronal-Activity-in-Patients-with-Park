...
n_subj_GA=size(Fq_GA_L,1);
n_subj_LA=size(Fq_LA_L,1);
...
%% Delta(0.5-3Hz) TEST
delta_Fq_LA_L1=mean(Fq_LA_L(:,6:31),2);delta_Fq_LA_R1=mean(Fq_LA_R(:,6:31),2);
[delta_Fq_LA_L, b_delta_Fq_LA_L1, bint_delta_Fq_LA_L1, ~] = regress_out(delta_Fq_LA_L1, score_pre_LA);
[delta_Fq_LA_L, b_delta_Fq_LA_L2, bint_delta_Fq_LA_L2, ~] = regress_out(delta_Fq_LA_L, score_post_LA);
[delta_Fq_LA_R, b_delta_Fq_LA_R1, bint_delta_Fq_LA_R1, ~] = regress_out(delta_Fq_LA_R1, score_pre_LA);
[delta_Fq_LA_R, b_delta_Fq_LA_R2, bint_delta_Fq_LA_R2, ~] = regress_out(delta_Fq_LA_R, score_post_LA);
delta_Fq_GA_L1=mean(Fq_GA_L(:,6:31),2);delta_Fq_GA_R1=mean(Fq_GA_R(:,6:31),2);
[delta_Fq_GA_L, b_delta_Fq_GA_L1, bint_delta_Fq_GA_L1, ~] = regress_out(delta_Fq_GA_L1, score_pre_GA);
[delta_Fq_GA_L, b_delta_Fq_GA_L2, bint_delta_Fq_GA_L2, ~] = regress_out(delta_Fq_GA_L, score_post_GA);
[delta_Fq_GA_R, b_delta_Fq_GA_R1, bint_delta_Fq_GA_R1, ~] = regress_out(delta_Fq_GA_R1, score_pre_GA);
[delta_Fq_GA_R, b_delta_Fq_GA_R2, bint_delta_Fq_GA_R2, ~] = regress_out(delta_Fq_GA_R, score_post_GA);
delta_Fq_LA1=mean(Fq_LA(:,6:31),2);delta_Fq_GA1=mean(Fq_GA(:,6:31),2);
[delta_Fq_LA, b_delta_Fq_LA1, bint_delta_Fq_LA1, ~] = regress_out(delta_Fq_LA1, score_pre_LA);
[delta_Fq_LA, b_delta_Fq_LA2, bint_delta_Fq_LA2, ~] = regress_out(delta_Fq_LA, score_post_LA);
[delta_Fq_GA, b_delta_Fq_GA1, bint_delta_Fq_GA1, ~] = regress_out(delta_Fq_GA1, score_pre_GA);
[delta_Fq_GA, b_delta_Fq_GA2, bint_delta_Fq_GA2, ~] = regress_out(delta_Fq_GA, score_post_GA);
...
%% Theta(4-8Hz) TEST
theta_Fq_LA_L1=mean(Fq_LA_L(:,41:81),2);theta_Fq_LA_R1=mean(Fq_LA_R(:,41:81),2);
[theta_Fq_LA_L, b_theta_Fq_LA_L1, bint_theta_Fq_LA_L1, ~] = regress_out(theta_Fq_LA_L1, score_pre_LA);
[theta_Fq_LA_L, b_theta_Fq_LA_L2, bint_theta_Fq_LA_L2, ~] = regress_out(theta_Fq_LA_L, score_post_LA);
[theta_Fq_LA_R, b_theta_Fq_LA_R1, bint_theta_Fq_LA_R1, ~] = regress_out(theta_Fq_LA_R1, score_pre_LA);
[theta_Fq_LA_R, b_theta_Fq_LA_R2, bint_theta_Fq_LA_R2, ~] = regress_out(theta_Fq_LA_R, score_post_LA);
theta_Fq_GA_L1=mean(Fq_GA_L(:,41:81),2);theta_Fq_GA_R1=mean(Fq_GA_R(:,41:81),2);
[theta_Fq_GA_L, b_theta_Fq_GA_L1, bint_theta_Fq_GA_L1, ~] = regress_out(theta_Fq_GA_L1, score_pre_GA);
[theta_Fq_GA_L, b_theta_Fq_GA_L2, bint_theta_Fq_GA_L2, ~] = regress_out(theta_Fq_GA_L, score_post_GA);
[theta_Fq_GA_R, b_theta_Fq_GA_R1, bint_theta_Fq_GA_R1, ~] = regress_out(theta_Fq_GA_R1, score_pre_GA);
[theta_Fq_GA_R, b_theta_Fq_GA_R2, bint_theta_Fq_GA_R2, ~] = regress_out(theta_Fq_GA_R, score_post_GA);
theta_Fq_LA1=mean(Fq_LA(:,41:81),2);theta_Fq_GA1=mean(Fq_GA(:,41:81),2);
[theta_Fq_LA, b_theta_Fq_LA1, bint_theta_Fq_LA, ~] = regress_out(theta_Fq_LA1, score_pre_LA);
[theta_Fq_LA, b_theta_Fq_LA2, bint_theta_Fq_LA2, ~] = regress_out(theta_Fq_LA, score_post_LA);
[theta_Fq_GA, b_theta_Fq_GA1, bint_theta_Fq_GA1, ~] = regress_out(theta_Fq_GA1, score_pre_GA);
[theta_Fq_GA, b_theta_Fq_GA2, bint_theta_Fq_GA2, ~] = regress_out(theta_Fq_GA, score_post_GA);
...
%% Alpha(8-14Hz) TEST
alpha_Fq_LA_L1=mean(Fq_LA_L(:,81:141),2);alpha_Fq_LA_R1=mean(Fq_LA_R(:,81:141),2);
[alpha_Fq_LA_L, b_alpha_Fq_LA_L1, bint_alpha_Fq_LA_LA1, ~] = regress_out(alpha_Fq_LA_L1, score_pre_LA);
[alpha_Fq_LA_L, b_alpha_Fq_LA_L2, bint_alpha_Fq_LA_LA2, ~] = regress_out(alpha_Fq_LA_L, score_post_LA);
[alpha_Fq_LA_R, b_alpha_Fq_LA_R1, bint_alpha_Fq_LA_R1, ~] = regress_out(alpha_Fq_LA_R1, score_pre_LA);
[alpha_Fq_LA_R, b_alpha_Fq_LA_R2, bint_alpha_Fq_LA_R2, ~] = regress_out(alpha_Fq_LA_R, score_post_LA);
alpha_Fq_GA_L1=mean(Fq_GA_L(:,81:141),2);alpha_Fq_GA_R1=mean(Fq_GA_R(:,81:141),2);
[alpha_Fq_GA_L, b_alpha_Fq_GA_L1, bint_alpha_Fq_GA_L1, ~] = regress_out(alpha_Fq_GA_L1, score_pre_GA);
[alpha_Fq_GA_L, b_alpha_Fq_GA_L2, bint_alpha_Fq_GA_L2, ~] = regress_out(alpha_Fq_GA_L, score_post_GA);
[alpha_Fq_GA_R, b_alpha_Fq_GA_R1, bint_alpha_Fq_GA_R1, ~] = regress_out(alpha_Fq_GA_R1, score_pre_GA);
[alpha_Fq_GA_R, b_alpha_Fq_GA_R2, bint_alpha_Fq_GA_R2, ~] = regress_out(alpha_Fq_GA_R, score_post_GA);
alpha_Fq_LA1=mean(Fq_LA(:,81:141),2);alpha_Fq_GA1=mean(Fq_GA(:,81:141),2);
[alpha_Fq_LA, b_alpha_Fq_LA1, bint_alpha_Fq_LA1, ~] = regress_out(alpha_Fq_LA1, score_pre_LA);
[alpha_Fq_LA, b_alpha_Fq_LA2, bint_alpha_Fq_LA2, ~] = regress_out(alpha_Fq_LA, score_post_LA);
[alpha_Fq_GA, b_alpha_Fq_GA1, bint_alpha_Fq_GA1, ~] = regress_out(alpha_Fq_GA1, score_pre_GA);
[alpha_Fq_GA, b_alpha_Fq_GA2, bint_alpha_Fq_GA2, ~] = regress_out(alpha_Fq_GA, score_post_GA);
...
%{
%% 0.5-25Hz All
all_Fq_LA_L1=mean(Fq_LA_L(:,6:121),2);all_Fq_LA_R1=mean(Fq_LA_R(:,6:121),2);
...
all_Fq_GA_L1=mean(Fq_GA_L(:,6:121),2);all_Fq_GA_R1=mean(Fq_GA_R(:,6:121),2);
...
all_Fq_LA1=mean(Fq_LA(:,6:121),2);all_Fq_GA1=mean(Fq_GA(:,6:121),2);
...
%}
%% Beta(14-31Hz) TEST
beta_Fq_LA_L1=mean(Fq_LA_L(:,141:311),2);beta_Fq_LA_R1=mean(Fq_LA_R(:,141:311),2);
[beta_Fq_LA_L, b_beta_Fq_LA_L1, bint_beta_Fq_LA_L1, ~] = regress_out(beta_Fq_LA_L1, score_pre_LA);
[beta_Fq_LA_L, b_beta_Fq_LA_L2, bint_beta_Fq_LA_L2, ~] = regress_out(beta_Fq_LA_L, score_pre_LA);
[beta_Fq_LA_R, b_beta_Fq_LA_R1, bint_beta_Fq_LA_R1, ~] = regress_out(beta_Fq_LA_R1, score_pre_LA);
[beta_Fq_LA_R, b_beta_Fq_LA_R2, bint_beta_Fq_LA_R2, ~] = regress_out(beta_Fq_LA_R, score_pre_LA);
beta_Fq_GA_L1=mean(Fq_GA_L(:,141:311),2);beta_Fq_GA_R1=mean(Fq_GA_R(:,141:311),2);
[beta_Fq_GA_L, b_beta_Fq_GA_L1, bint_beta_Fq_GA_L1, ~] = regress_out(beta_Fq_GA_L1, score_pre_GA);
[beta_Fq_GA_L, b_beta_Fq_GA_L2, bint_beta_Fq_GA_L2, ~] = regress_out(beta_Fq_GA_L, score_post_GA);
[beta_Fq_GA_R, b_beta_Fq_GA_R1, bint_beta_Fq_GA_R1, ~] = regress_out(beta_Fq_GA_R1, score_pre_GA);
[beta_Fq_GA_R, b_beta_Fq_GA_R2, bint_beta_Fq_GA_R2, ~] = regress_out(beta_Fq_GA_R, score_post_GA);
beta_Fq_LA1=mean(Fq_LA(:,141:311),2);beta_Fq_GA1=mean(Fq_GA(:,141:311),2);
[beta_Fq_LA, b_beta_Fq_LA1, bint_beta_Fq_LA1, ~] = regress_out(beta_Fq_LA1, score_pre_LA);
[beta_Fq_LA, b_beta_Fq_LA2, bint_beta_Fq_LA2, ~] = regress_out(beta_Fq_LA, score_pre_LA);
[beta_Fq_GA, b_beta_Fq_GA1, bint_beta_Fq_GA1, ~] = regress_out(beta_Fq_GA1, score_pre_GA);
[beta_Fq_GA, b_beta_Fq_GA2, bint_beta_Fq_GA2, ~] = regress_out(beta_Fq_GA, score_post_GA);
...
%% Gamma(31-100Hz) TEST
gamma_Fq_LA_L1=mean(Fq_LA_L(:,311:1001),2);gamma_Fq_LA_R1=mean(Fq_LA_R(:,311:1001),2);
[gamma_Fq_LA_L, b_gamma_Fq_LA_L1, bint_gamma_Fq_LA_L1, ~] = regress_out(gamma_Fq_LA_L1, score_pre_LA);
[gamma_Fq_LA_L, b_gamma_Fq_LA_L2, bint_gamma_Fq_LA_L2, ~] = regress_out(gamma_Fq_LA_L, score_post_LA);
[gamma_Fq_LA_R, b_gamma_Fq_LA_R1, bint_gamma_Fq_LA_R1, ~] = regress_out(gamma_Fq_LA_R1, score_pre_LA);
[gamma_Fq_LA_R, b_gamma_Fq_LA_R2, bint_gamma_Fq_LA_R2, ~] = regress_out(gamma_Fq_LA_R, score_post_LA);
gamma_Fq_GA_L1=mean(Fq_GA_L(:,311:1001),2);gamma_Fq_GA_R1=mean(Fq_GA_R(:,311:1001),2);
[gamma_Fq_GA_L, b_gamma_Fq_GA_L1, bint_gamma_Fq_GA_L1, ~] = regress_out(gamma_Fq_GA_L1, score_pre_GA);
[gamma_Fq_GA_L, b_gamma_Fq_GA_L2, bint_gamma_Fq_GA_L2, ~] = regress_out(gamma_Fq_GA_L, score_post_GA);
[gamma_Fq_GA_R, b_gamma_Fq_GA_R1, bint_gamma_Fq_GA_R1, ~] = regress_out(gamma_Fq_GA_R1, score_pre_GA);
[gamma_Fq_GA_R, b_gamma_Fq_GA_R2, bint_gamma_Fq_GA_R2, ~] = regress_out(gamma_Fq_GA_R, score_post_GA);
gamma_Fq_LA1=mean(Fq_LA(:,311:1001),2);gamma_Fq_GA1=mean(Fq_GA(:,311:1001),2);
[gamma_Fq_LA, b_gamma_Fq_LA1, bint_gamma_Fq_LA1, ~] = regress_out(gamma_Fq_LA1, score_pre_LA);
[gamma_Fq_LA, b_gamma_Fq_LA2, bint_gamma_Fq_LA2, ~] = regress_out(gamma_Fq_LA, score_post_LA);
[gamma_Fq_GA, b_gamma_Fq_GA1, bint_gamma_Fq_GA1, ~] = regress_out(gamma_Fq_GA1, score_pre_GA);
[gamma_Fq_GA, b_gamma_Fq_GA2, bint_gamma_Fq_GA2, ~] = regress_out(gamma_Fq_GA, score_post_GA);
